...
public enum StorableEventName {
    ...
    // ACCOUNT
    USER_LOGGED_IN, USER_NOT_LOGGED_IN, USER_REGISTERED, USER_NOT_REGISTERED, USER_ACTIVATED,
    USER_NOT_ACTIVATED_BECAUSE_USER_NOT_REGISTERED, USER_NOT_ACTIVATED_BECAUSE_LINK_EXPIRED,
    // ENGLISH
    LESSON_STARTED, EXCERCISES_STARTED, LESSON_FINISHED,
